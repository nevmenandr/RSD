...
| Параметр | Значение |
|----------|----------|
| Общее число документов | 305 |
| Совокупный объем слов | 15,638,502 |
| Средняя длина документа | 51274 слов |
| Общее число авторов | 93 |
| Число подкорпусов | 23 |
| Диапазон лет | 1763—1932 |
| Временной охват | 169 лет |
| Распределение по векам | XVIII в. (12), XIX в. (154), XX в. (23) |
