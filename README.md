...
| Параметр | Значение |
|----------|----------|
| Общее число документов | 256 |
| Совокупный объем слов | 14,071,952 |
| Средняя длина документа | 54969 слов |
| Общее число авторов | 75 |
| Число подкорпусов | 19 |
| Диапазон лет | 1763—1932 |
| Временной охват | 169 лет |
| Распределение по векам | XVIII в. (12), XIX в. (122), XX в. (17) |
| Наиболее частые годы | 1869 (8), 1861 (5), 1833 (5) |
