...
[Прозаические художественные тексты первой половины XIX века](author/fiction/period/19-1/README.md)

###### Вторая половина XIX в.

* [Небольшой набор из текстов 5 авторов для тестирования и демонстрации технологий](author/fiction/period/19-2/brevia/README.md)
* [Большой набор из текстов авторов](author/fiction/period/19-2/nonbrevia/README.md)
...
* Стихотворные и прозаические тексты
...
### Оригинальное vs. отредактированное

### Сгенерированные vs. естественные

* [Стихотворные тексты, сгенерированные char-based LSTM-моделями](generated/char_lstm/README.md)
